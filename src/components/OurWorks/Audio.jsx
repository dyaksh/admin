...
import AddAudio from "./AddWorks/AddAudio";
import ViewAudio from "./ViewWorks/ViewAudio";
...
const Audio = () => {
    ...
    const handleAddAudio = value => {
        setAddAudio(value);
    }

    const handleView = id =>{
        const temp = items.filter(item => item.id === id)
        setSelectedAudio(temp[0]);
        setViewAudio(true);
    }
    const handleViewAudio = value => {
        setViewAudio(value);
    }
    ...
    return (
        <>
            <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
                <div className="mb-1 w-full">
                    <div className="mb-4">
                        <nav className="flex mb-5" aria-label="Breadcrumb">
                            <ol className="inline-flex items-center space-x-1 md:space-x-2">
                                ...
                                <li>
                                    <div className="flex items-center">
                                        <svg className="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg>
                                        <Link to="#" className="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Audio</Link>
                                    </div>
                                </li>
                                <li>
                                    <div className="flex items-center">
                        ...
                        <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">Audio</h1>
                    </div>
                    <div className="sm:flex">
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-3 ml-auto">
                            <button type="button" onClick={() => setAddAudio(true)} data-modal-toggle="add-user-modal" className="w-1/2 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium inline-flex items-center justify-center rounded-lg text-sm px-3 py-2 text-center sm:w-auto">
            ...
            <AddAudio addAudio={addAudio} handleAddAudio={handleAddAudio} />
            <ViewAudio viewAudio={viewAudio} handleViewAudio={handleViewAudio}
