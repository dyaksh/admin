...
const AddAudio = ({ addAudio, handleAddAudio }) => {
    const setAddAudio = () => {
        handleAddAudio(false);
    }

    return (
        <div className={`${addAudio ? 'flex' : 'hidden'} fixed inset-0 z-50 justify-center items-center bg-black bg-opacity-50`} id="add-audio-modal" role={addAudio ? 'dialog' : ''}>
            <div className="relative w-full max-w-2xl px-4 h-full md:h-auto">
                ...
                <div className="bg-white rounded-lg shadow-lg relative">
                    ...
                    <div className="flex items-start justify-between p-5 border-b rounded-t">
                        ...
                        <button type="button" onClick={setAddAudio} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
                    ...
                    <div className="p-6 space-y-6">
                        <form action="#" onSubmit={(e) => {
                            ...
                            <div className="grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6 sm:col-span-6">
                                    <label htmlFor="url" className="text-sm font-medium text-gray-900 block mb-2">Audio URL</label>
                            ...
                            <div className="items-center p-6 border-t border-gray-200 rounded-b">
                                <button className="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Add Audio</button>
                            </div>
                        </form>
                    </div>
                </div>
